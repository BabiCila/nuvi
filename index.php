    ...
    <section class="portfolio">
      ...
      <div class="portfolio__projects">
        ...
        <div class="logo-animation">
          <img class="portfolio__subtitle" src="./assets/img/logo_animation.svg" alt="Logo animation">
        ...
        <div class="intro-outro">
          <img class="portfolio__subtitle" src="./assets/img/intro_e_outro.svg" alt="Intro and outro">
          <div style="padding:56.25% 0 0 0;position:relative;"><iframe
        ...
        <div class="logo-design">
          <img class="portfolio__subtitle" src="./assets/img/logo_design.svg" alt="Logo design">
          <div id="carouselLogoDesign" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_e-lens.jpg" class="d-block w-100"
                  alt="logo design e-lens">
              </div>
              <div class="carousel-item active">
                <img src="./assets/img/portfolio/logo_design/logo_design_codelabb.jpg" class="d-block w-100"
                  alt="logo design codelabb">
              </div>
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_corgi.jpg" class="d-block w-100"
                  alt="logo design corgi">
              </div>
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_cosmo_cart.jpg" class="d-block w-100"
                  alt="logo design cosmo cart">
              </div>
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_cries.jpg" class="d-block w-100"
                  alt="logo design cries">
              </div>
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_devs.jpg" class="d-block w-100"
                  alt="logo design devs">
              </div>
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_dishout.jpg" class="d-block w-100"
                  alt="logo design dishout">
              </div>
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_expedicao.jpg" class="d-block w-100"
                  alt="logo design expedicao">
              </div>
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_flame.jpg" class="d-block w-100"
                  alt="logo design flame">
              </div>
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_klc.jpg" class="d-block w-100"
                  alt="logo design klc">
              </div>
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_lisoca.jpg" class="d-block w-100"
                  alt="logo design lisoca">
              </div>
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_millyard.jpg" class="d-block w-100"
                  alt="logo design millyard">
              </div>
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_newtier.jpg" class="d-block w-100"
                  alt="logo design newtier">
              </div>
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_pilgrims.jpg" class="d-block w-100"
                  alt="logo design pilgrims">
              </div>
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_use_pets.jpg" class="d-block w-100"
                  alt="logo design use pets">
              </div>
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_versa.jpg" class="d-block w-100"
                  alt="logo design versa">
              </div>
              <div class="carousel-item">
                <img src="./assets/img/portfolio/logo_design/logo_design_zagalo.jpg" class="d-block w-100"
                  alt="logo design zagalo">
              </div>
            </div>
        ...
        <div class="custom-animation">
          <img class="portfolio__subtitle" src="./assets/img/custom_animation.svg" alt="Custom animations">
          <div style="padding:56.25% 0 0 0;position:relative;"><iframe
  ...
  <footer class="final">
    <div class="contact" id="contact">
      ...
      <div class="social-media">
        <a href="https://www.instagram.com/nuvistudio/" class="social-media__img"><img src="./assets/img/instagram.svg"
            alt="Image with link to social network Instagram"></a>
        <a href="https://www.linkedin.com/company/nuvi-studio/" class="social-media__img"><img
            src="./assets/img/linkedin.svg" alt="Image with link to social network LinkedIn"></a>
        <a href="https://dribbble.com/nuvistudio" class="social-media__img"><img src="./assets/img/dribbble.svg"
    ...
    <div class="copyright">
      &#169; NUVI STUDIO - DEVS BARBARA MEIRA AND VIVIAN DUARTE
    </div>
  </footer>
